...
public class Constants {
    ...
    public static final String KEY_ADD_LOGIN_ACCOUNT = "key_add_login_account";
    ...
    public static final String SDK_QUA = "V1_AND_OpenSDK_3.5.14.lite_1077_RDM_B";
    public static final String SDK_VERSION = "3.5.14.lite";
    public static final String SDK_VERSION_REPORT = "OpenSdk_3.5.14.lite";
    ...
    public static String APP_SPECIFIC_ROOT = SocializeProtocolConstants.PROTOCOL_KEY_TENCENT + File.separator + "mobileqq" + File.separator + "opensdk";
    ...
    public static String KEY_PASS_REPORT_VIA_PARAM = "key_pass_report_via_param";
    public static String KEY_PASS_REPORT_VIA_TIMELY = "key_pass_report_via_timely";
