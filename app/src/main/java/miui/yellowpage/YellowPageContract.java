...
public class YellowPageContract {
    ...
    public static final class HttpRequest {
        ...
        public static final class Helper {
            ...
            private boolean mRequestCache = true;
            private boolean mRequestServer = true;
            private boolean mRequireLogin = false;
            private boolean mRequireLocId = false;
            private boolean mRequestYellowPage = false;
            ...
            private Bundle constructParams() {
                ...
                for (String key : keys) {
                    bundle.putString(key, this.mParams.get(key));
                }
                return bundle;
            }

            private String getResult(Bundle params) {
                Bundle bundle = InvocationHandler.invoke(this.mContext, Method.REQUEST_HTTP, null, params);
