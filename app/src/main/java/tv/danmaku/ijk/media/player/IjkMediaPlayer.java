...
public final class IjkMediaPlayer extends AbstractMediaPlayer {
    ...
    private MyEveyntHandler mEventHandler;
    private int mListenerContext;
    private long mNativeAndroidIO;
    private long mNativeMediaDataSource;
    private long mNativeMediaPlayer;
    private int mNativeSurfaceTexture;
    private MyOnCMyontrolMessageListener mMyOnCMyontrolMessageListener;
    ...
    /* loaded from: 人卫/classes15.dex */
    public interface MyOnCMyontrolMessageListener {
    ...
    public static native int native_KeyInit(String str, String str2, Context context);
    ...
    private void initPlayer(IjkLibLoader ijkLibLoader) {
        ...
        if (myLooper != null) {
            this.mEventHandler = new MyEveyntHandler(this, myLooper);
        } else {
            Looper mainLooper = Looper.getMainLooper();
            if (mainLooper != null) {
                this.mEventHandler = new MyEveyntHandler(this, mainLooper);
            } else {
    ...
    */
    public void setDataSource(Context context, Uri uri, Map<String, String> map) throws IOException, IllegalArgumentException, SecurityException, IllegalStateException {
        ...
        } else if ("content".equals(scheme) && YellowPageContract.Settings.DIRECTORY.equals(uri.getAuthority()) && (uri = RingtoneManager.getActualDefaultRingtoneUri(context, RingtoneManager.getDefaultType(uri))) == null) {
    ...
    public int Init(String str, String str2, Context context) {
        int native_KeyInit = native_KeyInit(str, str2, context);
        if (native_KeyInit != 0) {
            return native_KeyInit;
        }
        native_setup(new WeakReference(this));
        return 0;
    }
    ...
    public void setWakeMode(Context context, int i) {
        ...
        PowerManager.WakeLock newWakeLock = ((PowerManager) context.getSystemService(Context.POWER_SERVICE)).newWakeLock(i | 536870912, IjkMediaPlayer.class.getName());
    ...
    @NBSInstrumented
    /* loaded from: 人卫/classes15.dex */
    public static class MyEveyntHandler extends Handler {
        private final WeakReference<IjkMediaPlayer> mWeakPlayer;
        public transient NBSRunnableInspect nbsHandler;

        public MyEveyntHandler(IjkMediaPlayer ijkMediaPlayer, Looper looper) {
            super(looper);
        ...
        public void handleMessage(Message message) {
            ...
            NBSRunnableInspect nBSRunnableInspect11 = this.nbsHandler;
    ...
    private static void postEventFromNative(Object obj, int i, int i2, int i3, Object obj2) {
        ...
        MyEveyntHandler eventHandler = ijkMediaPlayer.mEventHandler;
        if (eventHandler != null) {
            ijkMediaPlayer.mEventHandler.sendMessage(eventHandler.obtainMessage(i, i2, i3, obj2));
        }
    }

    public void setOnControlMessageListener(MyOnCMyontrolMessageListener myOnCMyontrolMessageListener) {
        this.mMyOnCMyontrolMessageListener = myOnCMyontrolMessageListener;
    }
    ...
    private static boolean onNativeInvoke(Object obj, int i, Bundle bundle) {
        MyOnCMyontrolMessageListener myOnCMyontrolMessageListener;
        ...
        if (onNativeInvokeListener == null || !onNativeInvokeListener.onNativeInvoke(i, bundle)) {
            if (i == 131079 && (myOnCMyontrolMessageListener = ijkMediaPlayer.mMyOnCMyontrolMessageListener) != null) {
                int i2 = bundle.getInt(OnNativeInvokeListener.ARG_SEGMENT_INDEX, -1);
                if (i2 < 0) {
                    throw new InvalidParameterException("onNativeInvoke(invalid segment index)");
                }
                String onControlResolveSegmentUrl = myOnCMyontrolMessageListener.onControlResolveSegmentUrl(i2);
